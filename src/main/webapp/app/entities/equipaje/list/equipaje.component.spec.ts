...
describe('Component Tests', () => {
  describe('Equipaje Management Component', () => {
    let comp: EquipajeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EquipajeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.equipajes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
