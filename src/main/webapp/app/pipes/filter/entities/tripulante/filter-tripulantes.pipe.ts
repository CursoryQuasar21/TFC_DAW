...
@Pipe({
  name: 'filterTripulantes',
})
export class FilterTripulantesPipe implements PipeTransform {
        ...
        switch (campo) {
          ...
          case 'avion': {
            if (element.avion !== undefined && element.avion !== null) {
              if (args[0][4] !== undefined && args[0][4] !== null && element.avion.id.toString().indexOf(args[0][4].toString()) > -1) {
                contArgs++;
              }
            }
            break;
