...
public class PilotoResource {
    ...
    public ResponseEntity<Piloto> updatePiloto(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, piloto.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Piloto> partialUpdatePiloto(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, piloto.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/pilotos")
    public ResponseEntity<List<Piloto>> getAllPilotos(Pageable pageable) {
        log.debug("REST request to get a page of Pilotos");
        Page<Piloto> page = pilotoService.findAll(pageable);
